...
export function Footer() {
    return (
        <footer className="w-full py-4 mt-auto border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950">
            <div className="container mx-auto px-4 flex flex-col items-center gap-4">
                <div className="flex items-center" style={{ gap: "2rem" }}>
                    <a
                        href="https://discord.gg/MTX3ANfN"
                        target="_blank"
                    ...
                    <a
                        href="https://www.facebook.com/profile.php?id=61580933676890"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-slate-500 hover:text-slate-900 dark:hover:text-slate-100 transition-colors"
                        aria-label="Facebook"
